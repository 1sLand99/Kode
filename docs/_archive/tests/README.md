...
│   ├── comprehensive-adapter-tests.test.ts
│   ├── chat-completions-e2e.test.ts
│   ├── responses-api-e2e.test.ts
│   ├── regression/
│   └── tools/
├── integration/                           # Integration tests (workflow + gated real calls)
│   ├── integration-cli-flow.test.ts
│   ├── integration-multi-turn-cli.test.ts
│   ├── diagnostic/
│   └── production/
└── e2e/                                   # Spawn/Ink interaction tests
```
...
bun test tests/unit/comprehensive-adapter-tests.test.ts
```
...
PRODUCTION_TEST_MODE=true bun test tests/integration/production/
```
...
### 🏭 Production Tests (`tests/integration/production/`)
...
TEST_GPT5_API_KEY=test-key bun test tests/integration/

# 3. Validate with production tests (real APIs)
PRODUCTION_TEST_MODE=true bun test tests/integration/production/

# 4. Check for regressions
bun test tests/unit/regression/
```
...
- [`../docs/upgrade_design.md`] - Refactor/upgrade design (repository architecture)
